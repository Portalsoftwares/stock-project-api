@extends('pdf.master', ['data' => null, 'title' => 'បញ្ជីរ ម៉ោងសិក្សា'])
@section('body1')
    @php
        $line_count = count($time);
    @endphp
    <div class="row">
        <div class="col-12 py-2">
            <h1 class="font-muollight font-13 text-center">បញ្ជីរ ម៉ោងសិក្សា</h1>
        </div>
        <div class="row">
                ...
                <table width="100%" autosize="1.6" style="border-collapse: collapse; border-style: solid;" cellpadding="8">
                    <thead>
                        <tr>
                            ...
                            <td class="font-siemreap font-13" style="width: 15%">ម៉ោងចាប់ផ្ដើម</td>
                            <td class="font-siemreap font-13" style="width: 15%">ម៉ោងបញ្ចប់</td>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($time as $key => $ex)
                            <tr>
