    ...
    <div class="row">
        ...
        <div class="col-12  mt-3" style="padding-bottom: 20px">
            <table  width="100%" autosize="1.6" style="border-collapse: collapse; border-style: solid;" cellpadding="8">
                <thead>
                    <tr>
                        <td class="font-siemreap font-14" style="width: 7%">ល.រ</td>
                        <td class="font-siemreap font-14" style="width: 28%">គោត្តនាមនិងនាម</td>
                        <td class="font-siemreap font-14" style="width: 20%">សារអេឡិចត្រូនិច</td>
                        <td class="font-siemreap font-14" style="width: 20%">លេខទូរស័ព្ទ</td>
                        <td class="font-siemreap font-14" style="width: 25%">តួនាទី</td>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($users as $key => $user)
                        <tr>
                            <td class="font-siemreap font-14" style="text-align: center;">
                                {{ $key + 1 }}
                            </td>
                            ...
                            <td class="font-siemreap font-14" style="text-align: left;">
                                {{ $user->phone }}
                            </td>
                    ...
                    <tr>
                        <td colspan="4">
                            <div style="width: 98%; text-align: right; padding: 3px;"> Total </div>
                        </td colspan="2">
                        <td class="font-siemreap font-14">
